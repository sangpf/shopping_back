...
//		String path = "upload/" + format + "." + ext;
		...
		String md5ByInputStream = MD5Utils.getMd5ByInputStream(inputStream);
		if(md5ByInputStream == null){
			md5ByInputStream = System.currentTimeMillis()+"";
		}

		//保存数据库 path
		String path = "upload/" + md5ByInputStream + "." + ext;
